  ...
  navbarPage(
    ...
    tabPanel("HOME", value = "home",
             ...
             link.click();
                                        ...
                                        '))),
                            fluidRow(
                              shiny::HTML("<center> <h1>CONNECTICUT CAREER PATHWAYS</h2></center>")
                              ),
                            # WHAT
                            fluidRow(
                                column(3),
                                column(6,
                                       ...
                                       shiny::HTML("<h5>An interactive tool to help you explore the actual paths Connecticut's 
                                                   ...
                                                   popularity of certain paths, typical wage growth, and more, you can
                            ...
                            fluidRow(
                                ...
                                column(6,
                                       ...
                                       shiny::HTML("<h5>To launch the Career Pathways tool, choose one of the options below. 
                                                   You will not be asked to provide any identifiable information, and 
                                                   you can revisit the tool to chart a different course 
